const translations = {
  fr: {
    ...
    not_found_desc:
      "Ce QR code n'est plus valide. Demandez un nouveau a l'imprimeur.",
    duplicate_print_job:
  ...
  en: {
    ...
    not_found_desc:
      "This QR code is no longer valid. Ask the printer for a new one.",
    duplicate_print_job:
      "An identical print job is already in progress. Please wait.",
  },
  wo: {
    ...
    not_found_desc:
      "QR code bii dootu dox. Laaj imprimeur bi mu may la bu bees.",
    duplicate_print_job:
      "Liggéey impression bu mel ni moo am ba ci yoon. Xaaral.",
  },
};
